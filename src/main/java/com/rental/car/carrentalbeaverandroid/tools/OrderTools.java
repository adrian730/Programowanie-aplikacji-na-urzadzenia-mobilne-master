...
public class OrderTools {
    ...
    public static String url_all_orders = "http://carbeaver.hekko24.pl/test/orders/get_all_orders.php";
    public static String url_order_details = "http://carbeaver.hekko24.pl/test/orders/get_order_details.php";
    public static String url_create_order = "http://carbeaver.hekko24.pl/test/orders/create_order.php";
    public static String url_delete_order = "http://carbeaver.hekko24.pl/test/orders/delete_order.php";
    public static String url_update_order = "http://carbeaver.hekko24.pl/test/orders/update_order.php";
